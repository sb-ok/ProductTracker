namespace ProductTracker.Forms
{
    partial class DeleteFromTree
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnOk.Location = new System.Drawing.Point(123, 57);
            ...
            this.label1.Text = "Вы собираетесь удалить объект и все его дочерние элементы. Продолжить?";
            // 
            // DeleteFromTree
            // 
